...
import com.microsoft.gradle.bs.importer.builder.jdtbuilder.AbstractImageBuilder;
...
public class JavaBaseImageBuilder extends AbstractImageBuilder {
	protected JavaBaseImageBuilder(JavaBuilder javaBuilder, boolean buildStarting, State newState,
			CompilationGroup compilationGroup) {
		super(javaBuilder, buildStarting, newState, compilationGroup);
	}
	...
	@Override
	public void compile(SourceFile[] units, SourceFile[] additionalUnits, boolean compilingFirstGroup) {
		super.compile(units, additionalUnits, compilingFirstGroup);
	}

	@Override
	public void createProblemFor(IResource resource, IMember javaElement, String message, String problemSeverity) {
		super.createProblemFor(resource, javaElement, message, problemSeverity);
	}

	@Override
	public void deleteGeneratedFiles(IFile[] deletedGeneratedFiles) {
		super.deleteGeneratedFiles(deletedGeneratedFiles);
	}

	@Override
	public SourceFile findSourceFile(IFile file, boolean mustExist) {
		return super.findSourceFile(file, mustExist);
	}
	...
	@Override
	public void finishedWith(String sourceLocator, CompilationResult result, char[] mainTypeName,
	...
	public ICompilationUnit fromIFile(IFile file) {
		return super.fromIFile(file);
	}

	@Override
	public void initializeAnnotationProcessorManager(Compiler newCompiler) {
		super.initializeAnnotationProcessorManager(newCompiler);
	}

	@Override
	public RuntimeException internalException(CoreException t) {
		return super.internalException(t);
	}

	@Override
	public boolean isExcludedFromProject(IPath childPath) throws JavaModelException {
		return super.isExcludedFromProject(childPath);
	}

	@Override
	public CompilationParticipantResult[] notifyParticipants(SourceFile[] unitsAboutToCompile) {
		return super.notifyParticipants(unitsAboutToCompile);
	}

	@Override
	public void processAnnotations(CompilationParticipantResult[] results) {
		super.processAnnotations(results);
	}

	@Override
	public void recordParticipantResult(CompilationParticipantResult result) {
		super.recordParticipantResult(result);
	}

	@Override
	public void storeProblemsFor(SourceFile sourceFile, CategorizedProblem[] problems) throws CoreException {
		super.storeProblemsFor(sourceFile, problems);
	}

	@Override
	public void storeTasksFor(SourceFile sourceFile, CategorizedProblem[] tasks) throws CoreException {
		super.storeTasksFor(sourceFile, tasks);
	}

	@Override
	public void updateProblemsFor(SourceFile sourceFile, CompilationResult result) throws CoreException {
		super.updateProblemsFor(sourceFile, result);
	}

	@Override
	public void updateTasksFor(SourceFile sourceFile, CompilationResult result) throws CoreException {
		super.updateTasksFor(sourceFile, result);
	}
	...
	public void writeClassFileContents(ClassFile classFile, IFile file, String qualifiedFileName,
		...
		super.writeClassFileContents(classFile, file, qualifiedFileName, isTopLevelType, compilationUnit);
	}
	...
	public boolean isCompiledAllAtOnce() {
		return this.compiledAllAtOnce;
	}
}
