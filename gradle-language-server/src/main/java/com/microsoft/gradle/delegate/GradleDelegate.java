...
public class GradleDelegate {
  ...
  static {
    ...
    // plugins
    delegateMap.put("application",
        Arrays.asList("org.gradle.api.plugins.JavaApplication", "org.gradle.api.plugins.ApplicationPluginConvention"));
    delegateMap.put("base",
        Arrays.asList("org.gradle.api.plugins.BasePluginExtension", "org.gradle.api.plugins.BasePluginConvention"));
    delegateMap.put("java",
        Arrays.asList("org.gradle.api.plugins.JavaPluginExtension", "org.gradle.api.plugins.JavaPluginConvention"));
