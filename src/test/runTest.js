...
var extensionDevelopmentPath = path.resolve(__dirname, '../../');
function runTestsWithGradle() {
    return __awaiter(this, void 0, void 0, function () {
        var fixtures, _i, fixtures_1, fixture;
...
function runTestsWithoutGradle() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, vscode_test_1.runTests({
                        extensionDevelopmentPath: extensionDevelopmentPath,
...
function runTestsWithNestedProjects() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, vscode_test_1.runTests({
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, runTestsWithGradle()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, runTestsWithMultiRoot()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, runTestsWithMultiProject()];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, runTestsWithNestedProjects()];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, runTestsWithoutGradle()];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 6:
